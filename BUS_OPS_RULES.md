...
Development Port: 8080 (outside internal service allocation)
...
- Status: OUTSIDE internal port ranges (internal services use 7000-8999)
- Usage: Temporary local testing only
- Production: GitHub Pages (external hosting, no ports)
- Compliance: Corporate infrastructure separate from internal services

INTERNAL PORT POLICY:
- SentryCite: 7341-7344 (reserved for internal projects)
- Lexopoly API: 3000-3999 (business applications)
