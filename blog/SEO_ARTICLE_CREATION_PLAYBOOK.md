...
3. **Download Photos**:
   ...
   - Download to: `Downloads/` folder (temporary)
...
mkdir -p blog/images/quotecreator/

# Move and rename from Downloads
mv "Downloads/original-filename.jpg" \
   "blog/images/quotecreator/qc-hero-professional-bruce-mars.jpg"
```

### Step 1.4: Photo Credit Documentation

**Add to**: `blog/PHOTO_CREDITS.md`
...
**Log deployment** to internal operations tracking.
